...
class StockApiController extends BaseApiController
{
	...
	public function CurrentStockWithMissing(\Psr\Http\Message\ServerRequestInterface $request, \Psr\Http\Message\ResponseInterface $response, array $args)
	{
		return $this->ApiResponse($response, $this->getStockService()->GetCurrentStockWithMissing(true));
	}
